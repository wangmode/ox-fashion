	...
	var uploader = WST.upload({
				...
				callback:function(f,file){
					...
					if(json.status==1){
					  	...
					  	var tdiv = $("<div style='width:75px;float:left;margin-right:5px;'><a target='_blank' href='"+WST.conf.RESOURCE_PATH+"/"+json.savePath+json.name+"'>"+
			                       "<img class='step_pic"+"' width='75' height='75' src='"+WST.conf.RESOURCE_PATH+"/"+json.savePath+json.thumb+"' v='"+json.savePath+json.name+"'></a></div>");
